...
import com.hhassistant.integration.telegram.dto.GetUpdatesRequest
import com.hhassistant.integration.telegram.dto.GetUpdatesResponse
import com.hhassistant.integration.telegram.dto.SendMessageRequest
import com.hhassistant.integration.telegram.dto.SendMessageResponse
...
class TelegramClient(
    ...
    @Qualifier("telegramRateLimiter") private val rateLimiter: com.hhassistant.ratelimit.ConfigurableRateLimiter,
    ...
    suspend fun sendMessage(
        text: String,
        replyMarkup: com.hhassistant.integration.telegram.dto.InlineKeyboardMarkup? = null,
    ...
    suspend fun getUpdates(
        ...
        limit: Int = 100,
        timeout: Int = 0,
    ): List<com.hhassistant.integration.telegram.dto.Update> {
        if (!enabled) {
